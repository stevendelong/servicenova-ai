    ...
    <div className="min-h-screen bg-[#0a0c0f] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Create your ServiceNova account</h1>
          <p className="text-slate-400 text-sm mt-2">Get started with your AI receptionist</p>
        </div>
        <SignUp
          appearance={{
            elements: {
